package flashcards.genalion.aquizo.adapter
...
import flashcards.genalion.aquizo.databinding.FlashcardItemBinding
import flashcards.genalion.aquizo.fragments.FlashcardsOptions
import flashcards.genalion.aquizo.room.Word

class FlashcardsAdapter(private val context: Context, private val functions: (FlashcardsOptions, Word) -> Unit): ListAdapter<Word, FlashcardsAdapter.WordViewHolder>(
    DiffCallback
) {
